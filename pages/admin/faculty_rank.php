...
<head>
  ...
  <title>UCC LMS | Faculty Rank</title>
...
">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Faculty Rank</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $sql_faculty = "SELECT * FROM faculty_rank ORDER BY id ASC";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of faculty ranks</h3>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">New Faculty Rank</h4>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="new_faculty_rank_name" id="new_faculty_rank_name" placeholder="Faculty Rank">
                    </div>
                  </div>
        ...
        <form id = "form_edit">
          <div class="modal fade edit" id="modal-edit">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Edit Faculty Rank</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  ...
                  <input type="hidden" name="edit_faculty_rank_id" id="edit_faculty_rank_id">
                  <div class="form-group">
                    <label>Rank Name</label>
                    <input type="text" class="form-control" name="edit_faculty_rank_name" id="edit_faculty_rank_name" placeholder="Rank Name">
                  </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$(function () {
  $('#form_new').validate({
    ...
    messages: {
      new_faculty_rank_name: {
        required: "Please provide a faculty rank name",
      }
    },
    errorElement: 'span',
...
$('#example1 tbody').on('click', '.btn-activate', function () {
  ...
  var faculty_rank_id = $(this).closest("tr").attr('id');
  ...
  $.ajax({
        ...
        cache: false,
        url: 'process_faculty_rank.php',
        data: {type:'activate',faculty_rank_id:faculty_rank_id},
        success:function(data){
          var response_data = JSON.parse(data);
          Toast.fire({
          icon: response_data.icon,
...
$.ajax({
      ...
      cache: false,
      url: 'process_faculty_rank.php',
      data: {type:'deactivate',faculty_rank_id:faculty_rank_id},
      success:function(data){
        var response_data = JSON.parse(data);
        Toast.fire({
        icon: response_data.icon,
...
$('#example1 tbody').on('click', '.btn-edit', function () {
  ...
  document.getElementById("edit_faculty_rank_id").value = $(this).closest("tr").attr('id');
  document.getElementById("edit_faculty_rank_name").value = $(this).closest("tr").children(":eq(1)").text();
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'process_faculty_rank.php',
          data: {type:'delete',faculty_rank_id:faculty_rank_id},
          success:function(data){

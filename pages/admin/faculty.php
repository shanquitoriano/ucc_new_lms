...
<!-- Main Sidebar Container -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href = "../admin/faculty_rank.php" class="nav-link">
              <i class="nav-icon fas fa-trophy"></i>
              <p>Faculty Rank</p>
            </a>
          </li>
          <li class="nav-item">
            <a href = "../admin/course.php" class="nav-link">
              <i class="nav-icon fas fa-graduation-cap"></i>
              <p>Course</p>
            </a>
          </li>
          <li class="nav-item">
            <a href = "../admin/subject.php" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>Subject</p>
            </a>
          </li>
          <li class="nav-item">
            <a href = "../admin/schedule.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    $sql_faculty= "SELECT * FROM  faculty_info ORDER BY id ASC";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="new_faculty_last_name" id="new_faculty_last_name" placeholder="Last Name">
                    </div>
                    <div class="form-group">
                      <label>First Name</label>
                      <input type="text" class="form-control" name="new_faculty_first_name"  id="new_faculty_first_name" placeholder="First Name">
                    </div>
                    <div class="form-group">
                      <label>Middle Name</label>
                      <input type="text" class="form-control" name="new_faculty_middle_name" id="new_faculty_middle_name" placeholder="Middle Name">
                    </div>
                    <div class="form-group">
                      <label>Email Address</label>
                      <input type="email" class="form-control" name="new_faculty_email_address" id="new_faculty_email_address" placeholder="Email Address">
                    </div>
                    <div class="form-group">
                      <label>Faculty Rank</label>
                      <select class="form-control select2" name = "new_faculty_rank" id = "new_faculty_rank" style="width: 100%;">
                        <option value="">Select Rank</option><option value="1">Professor </option><option value="2">Associate Professor I</option><option value="3">Associate Professor II</option><option value="4">Associate Professor III</option><option value="5">Associate Professor IV</option><option value="6">Assistant Professor I</option><option value="7">Assistant Professor II</option><option value="8">Assistant Professor III</option><option value="9">Assistant Professor IV</option><option value="10">Instructor III</option>                      </select>
                    </div>
                  </div>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Last Name</label>
                    <input type="text" class="form-control" name="edit_faculty_last_name" id="edit_faculty_last_name" placeholder="Last Name">
                  </div>
                  <div class="form-group">
                    <label>First Name</label>
                    <input type="text" class="form-control" name="edit_faculty_first_name"  id="edit_faculty_first_name" placeholder="First Name">
                  </div>
                  <div class="form-group">
                    <label>Middle Name</label>
                    <input type="text" class="form-control" name="edit_faculty_middle_name" id="edit_faculty_middle_name" placeholder="Middle Name">
                  </div>
                  <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" class="form-control" name="edit_faculty_email_address" id="edit_faculty_email_address" placeholder="Email Address">
                  </div>
                  <div class="form-group">
                    <label>Faculty Rank</label>
                    <select class="form-control select2" name = "edit_faculty_rank" id = "edit_faculty_rank" style="width: 100%;">
                      <option value="">Select Rank</option><option value="1">Professor </option><option value="2">Associate Professor I</option><option value="3">Associate Professor II</option><option value="4">Associate Professor III</option><option value="5">Associate Professor IV</option><option value="6">Assistant Professor I</option><option value="7">Assistant Professor II</option><option value="8">Assistant Professor III</option><option value="9">Assistant Professor IV</option><option value="10">Instructor III</option>                    </select>
                  </div>
                </div>
                <div class="modal-footer justify-content-between">
...
$(function () {
  $('#form_new').validate({
    rules: {
      new_faculty_last_name: {
        required: true
      },
      new_faculty_first_name: {
        required: true
      },
      new_faculty_rank: {
        required: true
      },
      new_faculty_email_address: {
        required: true,
        email: true,
      },
    ...
    messages: {
      new_faculty_last_name: {
        required: "Please provide a faculty last name",
      },
      new_faculty_first_name: {
        required: "Please provide a faculty first name",
      },
      new_faculty_rank: {
        required: "Please provide a faculty rank",
      },
      new_faculty_email_address: {
        required: "Please enter a email address",
        new_faculty_email_address: "Please enter a valid email address"
      }
    },
    errorElement: 'span',
...
$('#form_edit').validate({
    rules: {
      edit_faculty_last_name: {
        required: true
      },
      edit_faculty_first_name: {
        required: true
      },
      edit_faculty_rank: {
        required: true
      },
      edit_faculty_email_address: {
        required: true,
        email: true,
      },
...
$('#example1 tbody').on('click', '.btn-activate', function () {
  ...
  var faculty_id = $(this).closest("tr").attr('id');
  ...
  $.ajax({
        ...
        cache: false,
        url: 'process_faculty.php',
        data: {type:'activate',faculty_id:faculty_id},
        success:function(data){
          var response_data = JSON.parse(data);
          Toast.fire({
          icon: response_data.icon,
...
$.ajax({
      ...
      cache: false,
      url: 'process_faculty.php',
      data: {type:'deactivate',faculty_id:faculty_id},
      success:function(data){
        var response_data = JSON.parse(data);
        Toast.fire({
        icon: response_data.icon,
...
$('#example1 tbody').on('click', '.btn-edit', function () {
  ...
  var rank_id = $(this).closest("tr").children(":eq(2)").attr('id');

  document.getElementById("edit_faculty_id").value = $(this).closest("tr").attr('id');
  document.getElementById("edit_faculty_last_name").value = $(this).closest("tr").children(":eq(1)").attr('data-last_name');
  document.getElementById("edit_faculty_first_name").value = $(this).closest("tr").children(":eq(1)").attr('data-first_name');
  document.getElementById("edit_faculty_middle_name").value = $(this).closest("tr").children(":eq(1)").attr('data-middle_name');
  document.getElementById("edit_faculty_email_address").value = $(this).closest("tr").children(":eq(3)").text();

  $('#edit_faculty_rank').val(rank_id).trigger('change');
...
var faculty_id = $(this).closest("tr").attr('id');
var $faculty_row = $(this).closest("tr");
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'process_faculty.php',
          data: {type:'delete',faculty_id:faculty_id},
          success:function(data){

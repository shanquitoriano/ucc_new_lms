...
">
  ...
  <div class="content-wrapper">
    ...
    $sql_schedule = "SELECT * FROM schedule ORDER BY id ASC";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name = "new_schedule_day" id = "new_schedule_day" style="width: 100%;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="time" class="form-control" name="new_schedule_start_time" id="new_schedule_start_time" placeholder="Class Start Time">
                    </div>
                    <div class="form-group">
                      <label>Class End Time</label>
                      <input type="time" class="form-control" name="new_schedule_end_time" id="new_schedule_end_time" placeholder="Class End Time">
                    </div>
                  </div>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Schedule Day</label>
                    <select class="form-control select2" name = "edit_schedule_day" id = "edit_schedule_day" style="width: 100%;">
                      <option value="">Select Day</option>
                      <option value="Monday">Monday</option>
                      <option value="Tuesday">Tuesday</option>
                      <option value="Wednesday">Wednesday</option>
                  ...
                  <div class="form-group">
                    <label>Class Start Time</label>
                    <input type="time" class="form-control" name="edit_schedule_start_time" id="edit_schedule_start_time" placeholder="Class Start Time">
                  </div>

                  <div class="form-group">
                      <label>Class End Time</label>
                      <input type="time" class="form-control" name="edit_schedule_end_time" id="edit_schedule_end_time" placeholder="Class End Time">
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$(function () {
  $('#form_new').validate({
    ...
    messages: {
      new_schedule_day: {
        required: "Please provide a schedule day",
      },
      new_schedule_start_time: {
        required: "Please provide a schedule start time",
      },
      new_schedule_end_time: {
        required: "Please provide a schedule end time",
      }
    },
    errorElement: 'span',
...
$('#form_edit').validate({
    rules: {
      ...
      edit_schedule_start_time: {
        required: true
      },
      edit_schedule_end_time: {
        required: true
      },
    },
    messages: {
...
$('#example1 tbody').on('click', '.btn-activate', function () {
  ...
  $.ajax({
        ...
        cache: false,
        url: 'process_schedule.php',
        data: {type:'activate',schedule_id:schedule_id},
        success:function(data){
          var response_data = JSON.parse(data);
          Toast.fire({
          icon: response_data.icon,
...
$.ajax({
      ...
      cache: false,
      url: 'process_schedule.php',
      data: {type:'deactivate',schedule_id:schedule_id},
      success:function(data){
        var response_data = JSON.parse(data);
        Toast.fire({
        icon: response_data.icon,
...
$('#example1 tbody').on('click', '.btn-edit', function () {
  ...
  document.getElementById("edit_schedule_id").value = $(this).closest("tr").attr('id');
  document.getElementById("edit_schedule_day").value = $(this).closest("tr").children(":eq(1)").text();
  document.getElementById("edit_schedule_start_time").value = $(this).closest("tr").children(":eq(2)").attr('data-time');
  document.getElementById("edit_schedule_end_time").value = $(this).closest("tr").children(":eq(3)").attr('data-time');

  $('#edit_schedule_day').val($(this).closest("tr").children(":eq(1)").text()).trigger('change');
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'process_schedule.php',
          data: {type:'delete',schedule_id:schedule_id},
          success:function(data){

...
<head>
  ...
  <title>UCC LMS | Administrator</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href = "../admin/administrator.php" class="nav-link">
              <i class="nav-icon fas fa-user-shield"></i>
              <p>Administrator</p>
            </a>
            </li>
          <li class="nav-item">
            <a href = "../admin/faculty.php" class="nav-link <br />
...
">
            ...
            <li class="nav-item">
            <a href = "../admin/student.php" class="nav-link <br />
...
">
  ...
  <div class="content-wrapper">
    ...
    $sql_admin = "SELECT * FROM admin_info ORDER BY id ASC";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="new_administrator_last_name" id="new_administrator_last_name" placeholder="Last Name">
                    </div>
                    <div class="form-group">
                      <label>First Name</label>
                      <input type="text" class="form-control" name="new_administrator_first_name"  id="new_administrator_first_name" placeholder="First Name">
                    </div>
                    <div class="form-group">
                      <label>Middle Name</label>
                      <input type="text" class="form-control" name="new_administrator_middle_name" id="new_administrator_middle_name" placeholder="Middle Name">
                    </div>
                    <div class="form-group">
                      <label>Email Address</label>
                      <input type="email" class="form-control" name="new_administrator_email_address" id="new_administrator_email_address" placeholder="Email Address">
                    </div>                    
                  </div>
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <input type="hidden" name="edit_administrator_id" id="edit_administrator_id">
                  <div class="form-group">
                    <label>Last Name</label>
                    <input type="text" class="form-control" name="edit_administrator_last_name" id="edit_administrator_last_name" placeholder="Last Name">
                  </div>
                  <div class="form-group">
                    <label>First Name</label>
                    <input type="text" class="form-control" name="edit_administrator_first_name"  id="edit_administrator_first_name" placeholder="First Name">
                  </div>
                  <div class="form-group">
                    <label>Middle Name</label>
                    <input type="text" class="form-control" name="edit_administrator_middle_name" id="edit_administrator_middle_name" placeholder="Middle Name">
                  </div>
                  <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" class="form-control" name="edit_administrator_email_address" id="edit_administrator_email_address" placeholder="Email Address">
                  </div>
                </div>
                <div class="modal-footer justify-content-between">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
$(function () {
  $('#form_new').validate({
    rules: {
      new_administrator_last_name: {
        required: true
      },
      new_administrator_first_name: {
        required: true
      },
      new_administrator_email_address: {
        required: true,
        email: true,
      },
    ...
    messages: {
      new_administrator_last_name: {
        required: "Please provide a administrator last name",
      },
      new_administrator_first_name: {
        required: "Please provide a administrator first name",
      },
      new_administrator_email_address: {
        required: "Please enter a email address",
        new_administrator_email_address: "Please enter a valid email address"
      }
    },
    errorElement: 'span',
...
$('#form_edit').validate({
    rules: {
      edit_administrator_last_name: {
        required: true
      },
      edit_administrator_first_name: {
        required: true
      },
      edit_administrator_email_address: {
        required: true,
        email: true,
      },
...
$('#example1 tbody').on('click', '.btn-activate', function () {
  ...
  var administrator_id = $(this).closest("tr").attr('id');
  ...
  $.ajax({
        ...
        cache: false,
        url: 'process_administrator.php',
        data: {type:'activate',administrator_id:administrator_id},
        success:function(data){
          var response_data = JSON.parse(data);
          Toast.fire({
          icon: response_data.icon,
...
$.ajax({
      ...
      cache: false,
      url: 'process_administrator.php',
      data: {type:'deactivate',administrator_id:administrator_id},
      success:function(data){
        var response_data = JSON.parse(data);
        Toast.fire({
        icon: response_data.icon,
...
$('#example1 tbody').on('click', '.btn-edit', function () {
  ...
  document.getElementById("edit_administrator_id").value = $(this).closest("tr").attr('id');
  document.getElementById("edit_administrator_last_name").value = $(this).closest("tr").children(":eq(1)").attr('data-last_name');
  document.getElementById("edit_administrator_first_name").value = $(this).closest("tr").children(":eq(1)").attr('data-first_name');
  document.getElementById("edit_administrator_middle_name").value = $(this).closest("tr").children(":eq(1)").attr('data-middle_name');
  document.getElementById("edit_administrator_email_address").value = $(this).closest("tr").children(":eq(2)").text();
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
          ...
          cache: false,
          url: 'process_administrator.php',
          data: {type:'delete',administrator_id:administrator_id},
          success:function(data){

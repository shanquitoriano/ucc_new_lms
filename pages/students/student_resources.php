...
<ul class="navbar-nav">
  ...
  <li class="nav-item d-none d-sm-inline-block">
    <a href="student_resources.php?class=1" class="nav-link active">Resources</a>
  </li>
  <li class="nav-item d-none d-sm-inline-block">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of resources available</h3>                
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example3" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Title</th>
                    <th>Instruction</th>
                    <th width = "15%">Date Created <b style="font-size:12px">(Month/Day/Year)</b></th>
                  </tr>
                  </thead>
                  <tbody>
                  <?php

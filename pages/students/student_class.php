...
<ul class="navbar-nav">
  ...
  <li class="nav-item d-none d-sm-inline-block">
    <a href="student_class.php?class=1" class="nav-link active">Class</a>
  </li>
  <li class="nav-item d-none d-sm-inline-block">
  ...
  <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown user-menu">
        ...
        <span class="d-none d-md-inline">Quitoriano, Shan Matthew</span>
        </a>
        ...
        <img src="../../dist/img/user1-128x128.jpg" class="img-circle elevation-2" alt="User Image">
          <p style="color: #fff";>Quitoriano, Shan Matthew          <small>Member since 2023</small>
        </p>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Quitoriano, Shan</a>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12 col-md-12 col-lg-7 order-2 order-md-1">
          ...
          <div class="col-12 col-sm-7">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Missing Assignment</span>
      ...
      <div class="col-5">
        ...
        <p class="text-sm">Code
            <b class="d-block">ucc-lms-jkwvex</b>
          </p>

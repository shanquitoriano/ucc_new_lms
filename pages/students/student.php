...
<head>
  ...
  <title>UCC LMS | Classmates</title>
...
<ul class="navbar-nav">
  ...
  <li class="nav-item d-none d-sm-inline-block">
    <a href="student_assignment.php?class=1" class="nav-link">Assignment</a>
  </li>
  <li class="nav-item d-none d-sm-inline-block">
    <a href="student_resources.php?class=1" class="nav-link">Resources</a>
  </li>
  <li class="nav-item d-none d-sm-inline-block">
    <a href="student.php?class=1" class="nav-link active">Classmates</a>
  </li>
</ul>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Classmates</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
                          ...
                          <div class="card bg-light d-flex flex-fill">
                            ...
                            <div class="card-body pt-0">
                              <div class="row">
                                <div class="col-8">
                                  <h2 class="lead"><b>Ramos, Sidney</b></h2>
                                  <p class="text-muted text-sm"><b>Course: </b> Bachelor of Science in Information System </p>
                                  <p class="text-muted text-sm"><b>Date Joined: </b> July 01, 2023 12:15 pm </p>
                                </div>
